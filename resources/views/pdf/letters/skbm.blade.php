...
@section('content')
    ...
    <p>Berdasarkan data yang ada pada kami, orang tersebut di atas adalah benar-benar warga Desa {{ $letter->village->name }} dan status perkawinannya adalah <strong>BELUM MENIKAH</strong>.</p>
