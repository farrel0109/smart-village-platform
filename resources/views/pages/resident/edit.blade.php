...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
        <div>
            <h1 class="text-3xl font-black text-dark-grey dark:text-white">Edit Data Penduduk</h1>
            <p class="mt-1 text-text-secondary dark:text-gray-400">Perbarui data penduduk: {{ $resident->name }}</p>
        </div>
